...
public class BookDAOImpl implements BookDAO {
    ...
    private static String UPDATE_BOOK = "UPDATE Book SET name = ?, author = ?, quantity = ?, price = ? WHERE id = ?";
    private static String SEARCH_BY_NAME = "SELECT * FROM Book WHERE name LIKE ?";
    private static String GET_BOOK_BY_ID = "SELECT * FROM Book WHERE id = ?";
    private static String SELECT_ALL = "SELECT * FROM Book";
    private static String ADD_BOOK = "INSERT INTO Book (name, author, quantity, price) VALUES (?, ?, ?, ?)";
