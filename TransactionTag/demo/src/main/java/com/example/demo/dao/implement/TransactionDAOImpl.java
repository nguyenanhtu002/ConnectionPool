    ...
    public List<Transactions> getAllTransactions() {
        ...
        try {
            ...
            while (rs.next()) {;
                ...
                String descriptionTag = rs.getString("description"); TagFinance tagFinance =new TagFinance(tagId, name, descriptionTag);
                Transactions transaction = new Transactions("",title, description, amount, tagId, tagFinance);
