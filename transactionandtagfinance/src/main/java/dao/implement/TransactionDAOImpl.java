...
public class TransactionDAOImpl implements TransactionDAO {
    ...
    public List<Transaction> getAllTransactions() {
        ...
        try {
            ...
            String SELECT_ALL = "SELECT * FROM Transactions,TagFinance where tagId = id";
    ...
    public void insertTransaction(Transaction transaction) {
        ...
        try {
            conn = DataSource.getInstance().getConnection();
            String sql = "INSERT INTO Transactions (createdAt,title, description,amount,tagId) VALUES (?, ?,?,?,?)";
    ...
    public void updateTransaction(Transaction transaction, int id) {
        ...
        try {
            conn = DataSource.getInstance().getConnection();
            String UPDATE_TRANSACTION = "UPDATE Transactions SET createdAt =?,title=?, description =?,amount=?, WHERE tagId =?";
    ...
    public void deleteTransaction(int id) {
        ...
        try {
            conn = DataSource.getInstance().getConnection();
            String DELETE_TRAN = "DELETE FROM Transactions WHERE tagId =?";
...
//            e.printStackTrace();
    ...
    public List<Transaction> searchTransactionByTagfinal(int id) {
        ...
        String SEARCH_BY_ID = "SELECT * FROM Transactions,TagFinance WHERE tagId = ?";
        Connection conn = null;
        try {
            conn = DataSource.getInstance().getConnection();
    ...
    public List<Transaction> searchTransactionByName(String name) {
        List<Transaction> transactions = new ArrayList<>();
        String SEARCH_BY_ID = "SELECT * FROM Transactions inner join TagFinance \n" +
                "on Transactions.tagId = TagFinance.id where TagFinance.nameTag LIKE ?";
        Connection conn = null;
        try {
            conn = DataSource.getInstance().getConnection();
            PreparedStatement pstmt = conn.prepareStatement(SEARCH_BY_ID);
