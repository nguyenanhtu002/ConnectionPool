...
public class TagFinanceDAOImpl implements TagFinanceDAO {
    ...
    @Override
    public TagFinance createTagFinance(String name, String description) {
        Connection conn = null;
        TagFinance tagFinance = null;
        try {
            ...
            pstmt.executeUpdate();
            conn.commit();
            tagFinance = new TagFinance(name, description);
    ...
    @Override
    public TagFinance updateTagFinance(TagFinance tagFinance) {
        Connection conn = null;
        TagFinance tagFinanceResult = null;
        try {
            conn = DataSource.getInstance().getConnection();
            ...
            pstmt.executeUpdate();
            conn.commit();
            tagFinanceResult = new TagFinance(tagFinance.getName(), tagFinance.getDescription());
        } catch (SQLException e) {
            if (conn != null) {
                try {
                    conn.rollback();
        ...
        return tagFinanceResult;
    }

    public TagFinance updateTagFinance(String name, String description, int id) {
        Connection conn = null;
        TagFinance tagFinance = null;
        try {
            conn = DataSource.getInstance().getConnection();
