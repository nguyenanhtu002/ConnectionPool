...
public class TransactionServiceImpl implements TransactionService {
    ...
    @Override
    public BaseResponse create(TransactionRequest transactionRequest) {
        return new BaseResponse(MessageResponse.INF_TRAN,
                new TransactionResponse(transactionDAO.createTransaction(
