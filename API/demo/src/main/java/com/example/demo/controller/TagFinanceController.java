...
public class TagFinanceController {
    ...
    @PostMapping("/create")
    public void create(@RequestBody TagfinanceRequest tagfinanceRequest) throws Exception {
        tagFinanceService.createTagFinance(tagfinanceRequest) ;
    }
    ...
    public void update(@RequestBody TagfinanceRequest tagfinance, @PathVariable(name = "id") int id) throws Exception {
        tagFinanceService.updateTagFinance(tagfinance, id);
    }
